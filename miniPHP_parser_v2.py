...
def p_error(p):
    ...
    parse_error_count += 1  # 👈 Incrementa contador cada vez que hay error
...
if __name__ == '__main__':
    ...
    try:
        ...
        if parse_error_count > 0:
            print(f"\nSe detectaron {parse_error_count} error(es) sintáctico(s) en el código PHP.")
        else:
            print(" Amiguito, tengo el placer de informar que tu parser reconoció correctamente todo el código PHP.")
